                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <input style="width: 100%" type="text" readonly value=${
                                referral.firstName || ""
                            }></input>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <textarea style="width: 100%" type="text" readonly>${
                                referral.workExperience || ""
                            }</textarea>
                        </td>
                    </tr>
                    <!-- end copy -->
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">
                                <a href="${appHost}/forms/${
    referral.formName
}/${referral.submission}" target="_blank">
                                    ${appHost}/forms/${referral.formName}/${
    referral.submission
}
                                </a>
                            </p>
